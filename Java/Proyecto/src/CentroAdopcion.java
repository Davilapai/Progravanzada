...
public class CentroAdopcion implements Serializable {
    ...
    public void mostrarEstadistica() {
        ...
        if (conejos + perros + gatos == 30) {
            System.out.println("Este centro de adopcion es muy chiquito");
        } else {
            System.out.println("Este centro de adopcion es grandesito");
        }
        System.out.println("A continuacion se presentan las estadisticas del centro de adopcion " + nombre);
        System.out.println("Hay " + conejos + " conejitos.");
        System.out.println("Hay " + perros + " perritos.");
        System.out.println("Hay " + gatos + " gatitos.");
        System.out.println("Y las ganancias ascienden a: " + ganancias);
    }
